...
int TroopPurchasing::amountUnits()
{
    int amount;
...
void TroopPurchasing::purchaseUnitIterator(int player_ID, int troop_ID, int map_ID)
{
...
int TroopPurchasing::execute(int player_ID, int troop_ID)
{
    int map_ID = mapArea();
