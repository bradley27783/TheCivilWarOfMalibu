...
void database::createtable_pUnits(){
    ...
    try{
        ...
        cur->set_sql("CREATE TABLE IF NOT EXISTS production_Units (ID INTEGER PRIMARY KEY NOT NULL,Name CHAR(16),Income INTEGER,Cost INTEGER);");
        cur->prepare();
        cur->step();
    }
    catch( sqlite::exception e){
...
void database::createtable_map(){
    ...
    try{
        ...
        cur->set_sql("CREATE TABLE IF NOT EXISTS Map (ID INTEGER PRIMARY KEY NOT NULL,Name TEXT NOT NULL,Owned BOOLEAN NOT NULL, Attack INTEGER NOT NULL, Defence INTEGER NOT NULL, Income INTEGER NOT NULL);");
        cur->prepare();
        cur->step();
    }
    catch( sqlite::exception e){
