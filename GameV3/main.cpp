...
int Menu::menu_militaryUnits(int player_ID){
...
int Menu::menu_productionUnits(int player_ID){
    string sqliteFile = "civilwarofMalibu.db";
...
int Menu::store_Menu(int player_ID){
    int user_Input;
    while(user_Input != 1||2||3){
        ...
        switch(user_Input){
            case 1:
                menu_militaryUnits(player_ID);
                break;
            case 2:
                menu_productionUnits(player_ID);
                break;
            case 3:
                break;
        }
...
int Menu::main_Menu(int player_ID){
    ...
    switch(user_Input){
        ...
        case 2:
            ...
            break;
        case 3:
            move.execute(player_ID); //Move Units
            break;
        case 4:
            store_Menu(player_ID); //Store
            break;
        case 5:
...
int Menu::execute(int player_ID){
    main_Menu(player_ID);
