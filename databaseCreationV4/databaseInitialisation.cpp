...
class database{
    ...
    void createtable_mUnits(){
        ...
        try{
            ...
            cur->set_sql("CREATE TABLE IF NOT EXISTS military_Units (ID INTEGER PRIMARY KEY NOT NULL,Name TEXT,Attack INTEGER,Defence INTEGER,Cost INTEGER);");
            cur->prepare();
            cur->step();
        }
        catch( sqlite::exception e){
    ...
    void createtable_map(){
        ...
        try{
            ...
            cur->set_sql("CREATE TABLE IF NOT EXISTS Map (ID INTEGER PRIMARY KEY NOT NULL,Name TEXT,Owned BOOLEAN);");
            cur->prepare();
            cur->step();
        }
        catch( sqlite::exception e){
